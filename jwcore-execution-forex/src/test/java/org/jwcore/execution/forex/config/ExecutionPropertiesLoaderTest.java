...
class ExecutionPropertiesLoaderTest {
    ...
    void shouldLoadHappyPathProperties() throws Exception {
        ...
        assertEquals("forex", config.accountId());
        ...
        assertEquals("forex-execution-node-1", config.nodeId());
    }
